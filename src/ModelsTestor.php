...
trait ModelsTestor
{
    public function setModelTestable(string $modelClass, string $table = null)
    {
        if ($table) {
            $this->table = $table;
        }
    ...
    public function assertHasColumns($columns, ?string $modelClass = null, ?string $table = null)
    {
        ...
        $this->assertEquals([], collect($this->columns)->diffAssoc(Schema::getColumnListing($this->getModelTable()))->toArray());
        return $this;
    }
    ...
    public function assertHasBelongsToRelations(array $belongsToRelations, string $modelClass = null, string $table = null)
    {
        if ($modelClass) {
            $this->setModelTestable($modelClass, $table);
        }
    ...
    public function assertHasManyToManyRelations(array $manyToManyRelations, string $modelClass = null, string $table = null)
    {
        if ($modelClass) {
            $this->setModelTestable($modelClass, $table);
        }
    ...
    public function assertHasHasManyMorphRelations(array $hasManyMorphRelations, string $modelClass = null, string $table = null)
    {
        if ($modelClass) {
            $this->setModelTestable($modelClass, $table);
        }
    ...
    public function assertHasBelongsToMorphRelations(array $belongsToMorphRelations, string $modelClass = null, string $table = null)
    {
        if ($modelClass) {
            $this->setModelTestable($modelClass, $table);
        }
